  ...
  return (
    <div style={styles.page}>
      <header style={styles.header}>
        ...
        <div>
          <h1 style={styles.title}>Smart Receipt Scanner</h1>
          ...
          >
            ...
            {preview ? (
              ...
              <div style={styles.dropzoneInner}>
                ...
                <p style={styles.dropSub}>or click to browse · JPEG / PNG / WebP · max 10 MB</p>
              </div>
            )}
          </div>
...
const styles = {
  ...
  lineDesc: { fontSize: 13, color: "#94a3b8" },
  lineAmt: { fontSize: 13, fontWeight: 600, color: "#e2e8f0" },
